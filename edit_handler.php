...
<body>
    ...
    <div class="container" style="margin-top: 12rem;">
        <h3 style="text-align: center; margin-bottom: 20px; color:black;font-family: 'Cutive Mono' ,
            monospace;font-size:40px;margin-top:-8rem">Put Some Questions on <?php echo $subject; ?></h3>
        <form id="quizForm" method="post" action="handlers/quiz_edit_handler.php" name="quizForm"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <p><input type="text" class="form-control" value="<?php echo $row['question']; ?>"
                            id="<?php echo $row['question_number']; ?>" name="<?php echo $row['question_number']; ?>">
                    </p>
                    <p>Answer</p>
                    <p><input type="text" class="form-control"
                            id="question_answer_<?php echo $row['question_number']; ?>"
                            name="question_answer_<?php echo $row['question_number']; ?>"></p>
                </div>
                <?php
                ...
                <p>
                <div class="col-sm-10">
                    <img src="http://localhost<?php echo $row['question_image']; ?>" class="img-responsive"
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" id="submitEditQuiz" name="submitEditQuiz">Submit
                        Quiz</button>
                </div>
            </div>
        </form>
