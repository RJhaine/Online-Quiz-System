...
<body>
    <nav style="background-color:	#aa6f73;" class="navbar navbar-dark ">
        <a style="color: white;font-size:2rem;padding-right :2rem;" class="navbar-brand" href="#">Quiz</a>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost/quizapp/admin_page.php">Home <span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost/quizapp/check_result_admin.php">Check Results</a>
                </li>
                <li class="nav-item active">
            ...
            <span class="navbar-text">
                ...
                <a style="color: #851e3e; margin-left:-259px;font-size:18px;" class="nav-link" href="logout.php"><i
